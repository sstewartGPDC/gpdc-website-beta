...
function initQuickActions() {
    ...
    widget.innerHTML = `
        <div class="quick-actions-menu">
            ...
            <a href="intranet/index.html" class="quick-actions-item">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="quick-actions-item-text">
                    <div class="quick-actions-item-label">TeamGPDC</div>
                    <div class="quick-actions-item-value">Staff directory & resources</div>
                </div>
            </a>
...
// ==================== SITE TUTORIAL ====================
// Tutorial v2 is now in js/tutorial.js
// initTutorial() and showTutorial() are defined there and exposed globally.
